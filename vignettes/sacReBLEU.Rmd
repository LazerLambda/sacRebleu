...
function. To employ this function in this example, we first need to tokenize the data. The [`tok`](https://cran.r-project.org/package=tok) package (available on CRAN) offers the
